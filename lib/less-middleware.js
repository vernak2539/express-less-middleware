...
module.exports = function( publicDirectory ) {
	...
	// checks for absolute path override
	...
	var expressStartPath = path.join( publicDirectory && publicDirectory.match(':') ? '' : path.dirname( require.main.filename ), publicDirectory || './public' );
